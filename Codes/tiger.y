...
%type <var> lvalue
%type <declist> decs
%type <dec> dec tydeclist fundeclist vardec
%type <fundec> fundec
%type <namety> tydec
...
tydeclist: tydec tydeclist {$$ = A_TypeDec(EM_tokPos, A_NametyList($1, $2->u.type));}
...
fundeclist: fundec fundeclist {$$ = A_FunctionDec(EM_tokPos, A_FundecList($1, $2->u.function));}
